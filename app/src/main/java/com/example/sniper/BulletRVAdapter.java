...
public class BulletRVAdapter extends RecyclerView.Adapter<BulletRVAdapter.ViewHolder>  {
    ...
    public void onBindViewHolder(@NonNull BulletRVAdapter.ViewHolder holder, int position) {
        ...
        holder.bulletNameTV.setText(modal.getName());
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        private TextView bulletNameTV, bulletCalTV, bulletG1TV, bulletG7TV, bulletWeightTV, bulletStart_speedTV;

        public ViewHolder(@NonNull View itemView) {
            super(itemView);
            // initializing our text views
            bulletNameTV = itemView.findViewById(R.id.idTVBulletName);
